...
defmodule Tron.DelegatedResourceMessage do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Tron.DelegatedResourceList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          delegatedResource: [Tron.DelegatedResource.t()]
        }
  defstruct [:delegatedResource]

  field(:delegatedResource, 1, repeated: true, type: Tron.DelegatedResource)
end
...
defmodule Tron.AccountPaginated do
  ...
  defstruct [:account, :offset, :limit, :startTime, :endTime]

  field(:account, 1, type: Tron.Account)
  field(:offset, 2, type: :int64)
  field(:limit, 3, type: :int64)
  field(:startTime, 4, type: :int64)
  field(:endTime, 5, type: :int64)
end
...
defmodule Tron.Wallet.Service do
  ...
  rpc(:UpdateEnergyLimit, Tron.UpdateEnergyLimitContract, Tron.TransactionExtention)
  ...
  rpc(:GetAssetIssueListByName, Tron.BytesMessage, Tron.AssetIssueList)
  rpc(:GetAssetIssueById, Tron.BytesMessage, Tron.AssetIssueContract)
  ...
  rpc(:GetDelegatedResource, Tron.DelegatedResourceMessage, Tron.DelegatedResourceList)
  rpc(:GetDelegatedResourceAccountIndex, Tron.BytesMessage, Tron.DelegatedResourceAccountIndex)
